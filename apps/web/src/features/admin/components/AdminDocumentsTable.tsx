...
import { adminTableStyles, statusColors, formatDate } from './adminTable.styles';
...
const HEADERS = ['Filename', 'User', 'Stage', 'Status', 'Size', 'Created', 'Actions'];
...
export function AdminDocumentsTable() {
	...
	const { selected, toggleAll, toggleOne, remove, clear } = useSelection(documents);
