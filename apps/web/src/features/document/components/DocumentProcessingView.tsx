...
import { useDocumentEvents, type DocumentEventStage } from "@/shared/hooks";
...
const STAGES: StageInfo[] = [
  {
    ...
    description: "Extracting text and structure from your file",
  },
  {
    icon: Brain,
    label: "Generating summary",
    description: "Analyzing content and key points",
  },
  {
    icon: BookOpen,
    label: "Processing quiz & concepts",
    description: "Building quiz questions and knowledge graph",
  },
  {
    icon: CheckCircle2,
    label: "Ready",
