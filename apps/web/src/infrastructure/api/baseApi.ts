...
export const baseApi = createApi({
  ...
  tagTypes: ['User', 'Document', 'DocumentSummary', 'Quiz', 'QuizAttempt', 'Graph', 'Category', 'Roadmap', 'RoadmapProgress', 'Resource', 'AdminStats', 'AdminUsers', 'AdminRoadmaps', 'AdminDocuments'],
  endpoints: () => ({}),
});
