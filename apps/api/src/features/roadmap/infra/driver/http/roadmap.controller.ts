...
import {
  ROADMAP_PROGRESS_SERVICE,
  type IRoadmapProgressService,
...
export class RoadmapController {
  constructor(
    ...
    @Inject(ROADMAP_PROGRESS_SERVICE)
    private readonly progressService: IRoadmapProgressService,
  ) {}
  ...
  @Sse(':id/events')
  events(@Param('id') roadmapId: string): Observable<SseProgressEvent> {
    return this.progressService.streamProgress(roadmapId);
  }
