      ...
      const subConceptSchema = z.object({
        subConcepts: z.array(
          z.object({
            ...
            description: z
              .string()
              .describe("Brief description of the sub-concept"),
            ...
            learningObjective: z
              .string()
              .describe(
                "What the learner will understand after this sub-concept",
              ),
          }),
        ),
      });
...
Generate 3-5 sub-concepts ordered from foundational to advanced.`,
      ...
      this.logger.error(
        `Failed to generate sub-concepts for "${parentName}"`,
        error,
      );
      throw error;
    }
